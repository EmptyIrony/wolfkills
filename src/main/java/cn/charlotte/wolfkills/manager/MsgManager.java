...
public class MsgManager {
    ...
    public static void onPrivateMsgReceived(int subType, int msgId, long fromQQ, String msg, int font) {
    }
     ...
     * @param font        字体
     */
    public static void onDiscussMsgReceived(int subtype, int msgId, long fromDiscuss, long fromQQ, String msg, int font) {
    }
}
